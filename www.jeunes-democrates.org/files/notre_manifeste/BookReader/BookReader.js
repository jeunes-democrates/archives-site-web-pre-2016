...
function BookReader() {
    ...
    this.logoURL = 'http://www.jeunes-democrates.org';
...
BookReader.prototype.gotOpenLibraryRecord = function(self, olObject) {
    ...
    if (olObject) {
        ...
        $('#BRreturn a').attr( {'href': self.bookUrl, 'title': "" } );
...
BookReader.prototype.initUIStrings = function()
{
    ...
    var titles = { '.logo': 'retourner sur jeunes-democrates.org', // $$$ update after getting OL record
                   '.zoom_in': 'Zoom in',
                   '.zoom_out': 'Zoom out',
                   '.onepg': 'vue sur une page',
                   '.twopg': 'vue sur deux pages',
                   '.thumb': 'vignettes',
                   '.print': 'imprimer cette page',
                   '.embed': 'embarquer',
                   '.link': 'lien vers ce livre',
                   '.bookmark': 'marquer ce livre',
                   '.read': 'lire ce livre',
